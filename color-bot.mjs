...
class MCBot {
    ...
    initEvents() {
        ...
        this.bot.on('spawn', async () => {
            ...
            this.bot.chat("/login kelmas");
            

            // Auto disconnect
            await this.bot.waitForTicks(60);
            this.bot.chat("/m pijus_kelmutis Prisijungta sekmingai");
...
bots.push(new MCBot(`Atoi`))
bots.push(new MCBot(`meteor`))
bots.push(new MCBot(`NPC`))
